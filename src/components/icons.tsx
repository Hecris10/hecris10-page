...
export const Icons = {
    ...
    react: (props: LucideProps) => (
        <svg viewBox="0 0 512 512" height="4em" width="4em" fill="currentColor" {...props}>
...
export const getIcon = (name?: string, classes?: string) => {
    switch (name) {
        ...
        case "twitter":
            return <Icons.twitter className={classes || ""} />;
        case "github":
        ...
        case "bolt":
            return <Icons.bolt className={classes || ""} />;
        case "FaReact":
            return <Icons.FaReact className={classes || ""} />;
        case "RiNextjsFill":
            return <Icons.RiNextjsFill className={classes || ""} />;
        case "BiLogoTypescript":
            return <Icons.BiLogoTypescript className={classes || ""} />;
        case "SiExpress":
            return <Icons.SiExpress className={classes || ""} />;
        default:
